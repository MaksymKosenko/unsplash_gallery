...
//
//     final unsplashData = unsplashDataFromJson(jsonString);

import 'dart:convert';

List<UnsplashData> unsplashDataFromJson(String str) => List<UnsplashData>.from(json.decode(str).map((x) => UnsplashData.fromJson(x)));

String unsplashDataToJson(List<UnsplashData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class UnsplashData {
  ...
  factory UnsplashData.fromJson(Map<String, dynamic> json) => UnsplashData(
    id: json["id"],
    ...
    links: UnsplashDatumLinks.fromJson(json["links"]),
...
class UnsplashDatumLinks {
  ...
  factory UnsplashDatumLinks.fromJson(Map<String, dynamic> json) => UnsplashDatumLinks(
    self: json["self"],
    html: json["html"],
